...
const SvgComponent = (props: SvgProps & { focused?: boolean }) =>
  props.focused ? (
    <Svg width={25} height={24} fill="none" {...props}>
      <Path
        fill="#F5A80C"
        d="M12.475 10.889a3.944 3.944 0 1 1 0-7.89 3.944 3.944 0 0 1 0 7.89ZM3.6 19.96c.382-4.706 4.202-7.099 8.858-7.099 4.722 0 8.6 2.261 8.89 7.1.011.193 0 .789-.741.789H4.317c-.247 0-.738-.533-.717-.79Z"
      />
    </Svg>
  ) : (
